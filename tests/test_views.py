...
class RequestPayloadValidationErrorTestCase(unittest.TestCase):
    ...
    def test_constructors(self):
        ...
        self.assertEqual(exc.message, u'unrecognized JSON structure from request body')
        ...
        RequestPayloadValidationError(u'', True)
        RequestPayloadValidationError(u'', response=True)
        RequestPayloadValidationError(message=u'', response=True)
